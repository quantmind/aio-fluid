...
- [Task Managers](task_managers.md), when to use a TaskManager, a TaskConsumer or a TaskScheduler, and what each one does in a FastAPI app.
...
- [Extending the FastAPI App](task_fastapi.md), add your own routes to the task manager app and inject the same dependencies into them.
