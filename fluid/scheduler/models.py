...
from typing_extensions import Annotated, Doc, TypedDict, TypeVar
...
TD = TypeVar("TD", default=Any)
"""Type of the task manager dependencies, defaults to `Any`."""
...
class TaskRun(BaseModel, Generic[TP, TD], arbitrary_types_allowed=True):
    ...
    @property
    def deps(self) -> TD:
        """Dependencies of the [TaskManager][fluid.scheduler.TaskManager]
        running this task.
        ...
        """
        return cast(TD, self.task_manager.deps)
